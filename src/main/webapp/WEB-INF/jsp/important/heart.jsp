...
<html lang="en">
    ...
    <div style="text-align:center;">
        ...
        <script src="js/heart/Projector.js"></script>
        <script src="js/heart/CanvasRenderer.js"></script>

        <script src="js/heart/tween.min.js"></script>
        <script src="js/heart/Sparks.js"></script>

        <!-- load the font file from canvas-text -->

        <script src="js/heart/helvetiker_regular.typeface.js"></script>
